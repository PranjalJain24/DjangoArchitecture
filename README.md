...
![alt text](https://github.com/PranjalJain24/DjangoArchitecture/blob/master/django-mvt-based-control-flow.png)
...
#### Middleware:
![alt text](https://github.com/PranjalJain24/DjangoArchitecture/blob/master/wsgi_middlewares.png)
